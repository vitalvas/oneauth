...
func TestDecryptYubikeyOTP_InvalidOTP(t *testing.T) {
...
func TestDecryptYubikeyOTP_InvalidAESKey(t *testing.T) {
	engine, err := NewEngine("test-master-key-1234567890")
	assert.NoError(t, err)
...
func TestDecryptYubikeyOTP_CRCFailure(t *testing.T) {
	engine, err := NewEngine("test-master-key-1234567890")
	assert.NoError(t, err)
...
func TestOTPData_Structure(t *testing.T) {
...
func TestVerifyCRC_KnownValues(t *testing.T) {
...
func TestDecryptYubikeyOTP_EdgeCases(t *testing.T) {
	engine, err := NewEngine("test-master-key-1234567890")
	assert.NoError(t, err)
